    ...
    Row(
        ...
        Text(
            text = if (isDistance) {
                ...
                if (isMoreThanKm) {
                    "${DecimalFormat("#.#").format(distanceInKms)}${stringResource(id = ge.transitgeorgia.R.string.km)}"
                } else "${DecimalFormat("#.#").format(distance)}${stringResource(id = ge.transitgeorgia.R.string.m)}"
            } else "ID:${stop.code}",
            modifier = Modifier
